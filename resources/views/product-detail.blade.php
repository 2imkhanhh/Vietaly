            ...
            <div class="product-detail-grid">
                    ...
                    <div class="gallery-main">
                        ...
                        <div class="main-image-container">
                            <div class="main-image-track" id="main-image-track">
                                <img src="{{ asset('images/productdetail1.png') }}" alt="Main Product Image 1" class="gallery-img">
                                <img src="{{ asset('images/productdetail2.png') }}" alt="Main Product Image 2" class="gallery-img">
                                <img src="{{ asset('images/productdetail3.png') }}" alt="Main Product Image 3" class="gallery-img">
                            </div>
                        </div>
                ...
                <div class="product-info-panel">
                    ...
                    <p class="product-desc">
                        Hãy tận hưởng những hương vị mê hoặc từ Bộ sưu tập The Faiseurs. Thưởng thức trọn vẹn dải hương vị tuyệt vời của các dòng sô-cô-la đen thượng hạng.
                    </p>
