        ...
        <div class="custom-container">
            ...
            <div class="cart-container">
                <div class="cart-items">
                    <div class="cart-item">
                        ...
                        <div class="cart-item-info">
                            <div class="cart-item-name">The Faiseurs Collection 6 Chocolate Bars Gift Box - Easter Edition
                            </div>
                        </div>
                ...
                <div class="ticket">
                    ...
                    <a href="/thanh-toan" class="checkout-btn"
                        style="display: block; box-sizing: border-box; text-decoration: none;">Tiến hành thanh toán</a>
                </div>
            </div>
        </div>
    </div>
